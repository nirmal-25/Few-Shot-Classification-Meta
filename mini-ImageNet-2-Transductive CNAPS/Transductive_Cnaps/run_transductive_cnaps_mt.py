...
class Learner:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--pretrained_resnet_path", default="./pretrained_resnets/pretrained_resnet_mini_imagenet.pt.tar",
        ...
        parser.add_argument("--checkpoint_dir", "-c", default='./weights', help="Directory to save checkpoint to.")
